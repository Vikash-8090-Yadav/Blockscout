            ...
            <div className="ml-10 flex items-center space-x-4">
              {accountAddress ? (
                <button
                  ...
                  className="bg-white bg-opacity-20 p-1 rounded-full text-white hover:bg-opacity-30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-600 focus:ring-white transition duration-300 ease-in-out transform hover:scale-105"
                >
